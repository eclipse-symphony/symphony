...
%LINKSERVER_BIN%/crt_emu_cm_redlink --flash-load-exec "%MCUX_WORKSPACE_LOC%/evkmimxrt1170_bubble_peripheral_cm7/Release/evkmimxrt1170_bubble_peripheral_cm7.axf" -p MIMXRT1176xxxxx --ConnectScript RT1170_connect_M7_wake_M4.scp --ResetScript RT1170_reset.scp -ProbeHandle=1 -CoreIndex=0 --flash-driver= -x %MCUX_WORKSPACE_LOC%/evkmimxrt1170_bubble_peripheral_cm7/Release --flash-dir %MCUX_FLASH_DIR0% --flash-dir %MCUX_FLASH_DIR1% --no-packed --flash-hashing