...
When Symphony is hosted on a platform such as Kubernetes or Azure ARM, it inherits RBAC control from the corresponding system. This applies to not only the CatalogVersion objects, but also to other objects as well.
