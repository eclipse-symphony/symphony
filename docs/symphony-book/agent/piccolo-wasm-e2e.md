...
1. Delete Symphony objects
    ...
    ```
2. Shutdown Flatcar VM.

## Appendix I: Challenges (November 2023)

1. Docker WASM runtime shim support
...
## Appendix II: Furture Investigations

1. Look at eBPF CO-RE and usage of map and circular buffer. We may consider injecting some user space code (as sidecars, for instance) to help to extract and forward data.
2. Look at projects like [inspektor-gadget](https://github.com/inspektor-gadget/inspektor-gadget), [BCC](https://github.com/iovisor/bcc) and [Cilium](https://cilium.io/).
3. Investigate Prometheus integration options like [ebpf_exporter](https://github.com/cloudflare/ebpf_exporter) (and the inspektor-gadget project above).
4. Serving Flatcar ignition files.
