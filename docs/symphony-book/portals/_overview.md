...
* The KubeAI Application Nucleus for edge (KAN)  project uses Symphony as its backend API. It provides an intuitive portal experience for users to create and deploy artificial intelligence solutionversions, especially computer-vision solutionversions, at edge.
