...
func (in *InstanceHistorySpec) DeepCopy() *InstanceHistorySpec {
	...
	out := new(InstanceHistorySpec)in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstanceStatusHistory) DeepCopyInto(out *InstanceStatusHistory) {
	*out = *in
	if in.Properties != nil {
		in, out := &in.Properties, &out.Properties
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstanceStatusHistory.
func (in *InstanceStatusHistory) DeepCopy() *InstanceStatusHistory {
	if in == nil {
		return nil
	}
	out := new(InstanceStatusHistory)
	in.DeepCopyInto(out)
	return out
}
