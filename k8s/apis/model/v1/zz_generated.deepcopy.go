...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CampaignVersionSpec) DeepCopyInto(out *CampaignVersionSpec) {
	*out = *in
	if in.Stages != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CampaignVersionSpec.
func (in *CampaignVersionSpec) DeepCopy() *CampaignVersionSpec {
	if in == nil {
		return nil
	}
	out := new(CampaignVersionSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CatalogVersionSpec) DeepCopyInto(out *CatalogVersionSpec) {
	*out = *in
	if in.Metadata != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CatalogVersionSpec.
func (in *CatalogVersionSpec) DeepCopy() *CatalogVersionSpec {
	if in == nil {
		return nil
	}
	out := new(CatalogVersionSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentDeployableStatus) DeepCopyInto(out *ComponentDeployableStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentDeployableStatus.
func (in *ComponentDeployableStatus) DeepCopy() *ComponentDeployableStatus {
	if in == nil {
		return nil
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeployableStatusV2) DeepCopyInto(out *DeployableStatusV2) {
	*out = *in
	in.ProvisioningStatus.DeepCopyInto(&out.ProvisioningStatus)
	in.LastModified.DeepCopyInto(&out.LastModified)
	if in.TargetStatuses != nil {
		in, out := &in.TargetStatuses, &out.TargetStatuses
		*out = make([]TargetDeployableStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeployableStatusV2.
func (in *DeployableStatusV2) DeepCopy() *DeployableStatusV2 {
	if in == nil {
		return nil
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstanceHistorySpec) DeepCopyInto(out *InstanceHistorySpec) {
	*out = *in
	...
	in.SolutionVersion.DeepCopyInto(&out.SolutionVersion)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstanceHistorySpec.
func (in *InstanceHistorySpec) DeepCopy() *InstanceHistorySpec {
	if in == nil {
		return nil
	}
	out := new(InstanceHistorySpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SolutionVersionSpec) DeepCopyInto(out *SolutionVersionSpec) {
	*out = *in
	if in.Metadata != nil {
		in, out := &in.Metadata, &out.Metadata
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SolutionVersionSpec.
func (in *SolutionVersionSpec) DeepCopy() *SolutionVersionSpec {
	if in == nil {
		return nil
	}
	out := new(SolutionVersionSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TargetDeployableStatus) DeepCopyInto(out *TargetDeployableStatus) {
	*out = *in
	if in.ComponentStatuses != nil {
		in, out := &in.ComponentStatuses, &out.ComponentStatuses
		*out = make([]ComponentDeployableStatus, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TargetDeployableStatus.
func (in *TargetDeployableStatus) DeepCopy() *TargetDeployableStatus {
	if in == nil {
		return nil
	}
