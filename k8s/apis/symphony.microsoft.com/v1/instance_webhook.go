...
//+kubebuilder:webhook:path=/mutate-symphony-microsoft-com-v1-instance,mutating=true,failurePolicy=fail,sideEffects=None,groups=symphony.microsoft.com,resources=instances,verbs=create;update,versions=v1,name=minstance.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-symphony-microsoft-com-v1-instance,mutating=false,failurePolicy=fail,sideEffects=None,groups=symphony-microsoft-com,resources=instances,verbs=create;update,versions=v1,name=vinstance.kb.io,admissionReviewVersions=v1
