...
//+kubebuilder:rbac:groups=ai.symphony,resources=skills,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=ai.symphony,resources=skills/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=ai.symphony,resources=skills/finalizers,verbs=update
