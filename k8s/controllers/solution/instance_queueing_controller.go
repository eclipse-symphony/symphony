...
func (r *InstanceQueueingReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	log.Info("Reconcile Updating Instance " + req.Name + " in namespace " + req.Namespace + instance.ResourceVersion)
	return ctrl.Result{RequeueAfter: 10 * time.Second}, nil
}

func (r *InstanceQueueingReconciler) deploymentBuilder(ctx context.Context, object reconcilers.Reconcilable) (*model.DeploymentSpec, error) {
	log := ctrllog.FromContext(ctx)
...
func (r *InstanceQueueingReconciler) buildDeploymentReconciler() (reconcilers.Reconciler, error) {
...
func (r *InstanceQueueingReconciler) handleTarget(ctx context.Context, obj client.Object) []ctrl.Request {
...
func (r *InstanceQueueingReconciler) handleSolution(ctx context.Context, obj client.Object) []ctrl.Request {
	ret := make([]ctrl.Request, 0)
