...
//+kubebuilder:rbac:groups=solutionversion.symphony,resources=instances,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=solutionversion.symphony,resources=instances/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=solutionversion.symphony,resources=instances/finalizers,verbs=update
