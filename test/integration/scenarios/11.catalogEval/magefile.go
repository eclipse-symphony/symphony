...
var (
	// catalogs to deploy
	testCatalogs = []string{
		"test/integration/scenarios/11.catalogEval/manifest/catalog-catalog-container.yaml",
		"test/integration/scenarios/11.catalogEval/manifest/catalog-catalog.yaml",
		"test/integration/scenarios/11.catalogEval/manifest/catalog-catalog2.yaml",
		"test/integration/scenarios/11.catalogEval/manifest/catalog-catalog3.yaml",
	}
	...
	testEval = "test/integration/scenarios/11.catalogEval/manifest/eval.yaml"

	testWrongEval = "test/integration/scenarios/11.catalogEval/manifest/wrongEval.yaml"

	testEvalUpdate = "test/integration/scenarios/11.catalogEval/manifest/evalUpdate.yaml"

	testEval03 = "test/integration/scenarios/11.catalogEval/manifest/eval03.yaml"
)
