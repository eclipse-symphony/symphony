...
func TestIntefaceConvertion(t *testing.T) {
	var val interface{} = CatalogVersionState{}
	var iNode v1alpha2.INode = val.(v1alpha2.INode)
	assert.NotNil(t, iNode)
}
func TestCatalogMatch(t *testing.T) {
	catalog1 := CatalogVersionSpec{
		ParentName: "parentName",
		Properties: map[string]interface{}{
			"key": "value",
		},
	}
	catalog2 := CatalogVersionSpec{
		ParentName: "parentName",
		Properties: map[string]interface{}{
			"key": "value",
		},
...
func TestCatalogMatchOneEmpty(t *testing.T) {
	...
	assert.EqualError(t, err, "parameter is not a CatalogVersionSpec type")
	assert.False(t, res)
}
