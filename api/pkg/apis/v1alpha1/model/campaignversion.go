...
type CampaignVersionState struct {
	ObjectMeta ObjectMeta    `json:"metadata,omitempty"`
	Spec       *CampaignVersionSpec `json:"spec,omitempty"`
}
...
func (c ActivationSpec) DeepEquals(other IDeepEquals) (bool, error) {
	...
	if c.CampaignVersion != otherC.CampaignVersion {
		return false, errors.New("campaignversion doesn't match")
	}
...
func (c CampaignVersionSpec) DeepEquals(other IDeepEquals) (bool, error) {
	otherC, ok := other.(CampaignVersionSpec)
	if !ok {
		return false, errors.New("parameter is not a CampaignVersionSpec type")
	}
...
func (c CampaignVersionState) DeepEquals(other IDeepEquals) (bool, error) {
	otherC, ok := other.(CampaignVersionState)
	if !ok {
		return false, errors.New("parameter is not a CampaignVersionState type")
	}
