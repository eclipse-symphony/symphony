...
func TestConvertAzureSolutionVersionReferenceToObjectName(t *testing.T) {
	var azureSolutionVersionRef = "/subscriptions/XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX/resourcegroups/testrg/providers/Private.Edge/targets/target3/solutionversions/sol3/versions/ver1"
...
func TestConvertAzureSolutionVersionReferenceToObjectNameWithInvalidReference(t *testing.T) {
	var azureSolutionVersionRef = "/subscriptions/XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX/resourceGroups/testrg/providers/Private.Edge/targets/target3/solutionversions/sol3/versions"
	objName, success := ConvertAzureSolutionVersionReferenceToObjectName(azureSolutionVersionRef)
