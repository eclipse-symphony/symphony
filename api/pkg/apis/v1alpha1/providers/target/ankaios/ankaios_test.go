...
func TestInit(t *testing.T) {
	targetProvider := &AnkaiosTargetProvider{}
	err := targetProvider.Init(AnkaiosTargetProviderConfig{})
	assert.Nil(t, err)
}
...
func TestInitWithMap(t *testing.T) {
	...
	provider := AnkaiosTargetProvider{}
...
func TestMockTargetProviderApply(t *testing.T) {
	provider := &AnkaiosTargetProvider{}
	err := provider.Init(AnkaiosTargetProviderConfig{})
	assert.Nil(t, err)
