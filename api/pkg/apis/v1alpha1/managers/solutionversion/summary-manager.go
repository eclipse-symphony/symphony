...
func (s *SummaryManager) GetDeploymentState(ctx context.Context, instance string, namespace string) *SolutionVersionManagerDeploymentState {
	...
	if err == nil {
		var managerState SolutionVersionManagerDeploymentState
...
func (s *SummaryManager) UpsertDeploymentState(ctx context.Context, instance string, namespace string, deployment model.DeploymentSpec, mergedState model.DeploymentState) error {
	_, err := s.StateProvider.Upsert(ctx, states.UpsertRequest{
		Value: states.StateEntry{
			ID: instance,
			Body: SolutionVersionManagerDeploymentState{
				Spec:  deployment,
				State: mergedState,
			},
		},
