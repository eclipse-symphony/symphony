...
class State(IntEnum):
    ...
    def __str__(self) -> str:
        ...
        state_strings = {
            ...
            State.WAIT_TO_GET_CATALOGS_FAILED: "Wait To Get CatalogVersions Failed",
            State.INVALID_WAIT_OBJECT_TYPE: "Invalid Wait Object Type",
            State.CATALOGS_GET_FAILED: "Get CatalogVersions Failed",
            State.INVALID_INSTANCE_CATALOG: "Invalid Instance CatalogVersion",
            State.CREATE_INSTANCE_FROM_CATALOG_FAILED: "Create Instance From CatalogVersion Failed",
            State.INVALID_SOLUTION_CATALOG: "Invalid SolutionVersion Object in CatalogVersion",
            State.CREATE_SOLUTION_FROM_CATALOG_FAILED: "Create SolutionVersion Object From CatalogVersion Failed",
            State.INVALID_TARGET_CATALOG: "Invalid Target Object in CatalogVersion",
            State.CREATE_TARGET_FROM_CATALOG_FAILED: "Create Target Object From CatalogVersion Failed",
            State.INVALID_CATALOG_CATALOG: "Invalid CatalogVersion Object in CatalogVersion",
            State.CREATE_CATALOG_FROM_CATALOG_FAILED: "Create CatalogVersion Object From CatalogVersion Failed",
            ...
            State.SOLUTION_GET_FAILED: "SolutionVersion does not exist",
